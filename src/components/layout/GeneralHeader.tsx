...
const GeneralHeader: React.FC = () => {
  ...
  const currentDashboard = dashboards.find(d => location.pathname.startsWith(d.path)) || dashboards[3];
      ...
      <div className="flex items-center justify-between px-6 py-4 h-full">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 font-medium">{currentDashboard.description}</p>
          </div>
        </div>
