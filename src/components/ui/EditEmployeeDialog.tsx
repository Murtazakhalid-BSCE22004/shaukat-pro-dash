...
const EditEmployeeDialog: React.FC<EditEmployeeDialogProps> = ({ open, onOpenChange, employee }) => {
  ...
  const updateEmployeeMutation = useMutation({
    mutationFn: ({ id, updates }: { id: string; updates: Partial<Employee> }) =>
      supabaseEmployeesService.updateEmployee(id, updates),
    onSuccess: () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateEmployeeMutation.mutateAsync({ id: employee.id, updates });
    } catch (error) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  style={{ border: '1px solid #e5e7eb !important', outline: 'none !important', boxShadow: 'none !important' }}
                  onFocus={(e) => {
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    ...
                    // Auto-update department if it matches the old position
